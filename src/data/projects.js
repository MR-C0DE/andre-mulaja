...
},
{
    ...
    media: {
        ...
        files: [
            ...
            name: "Video explain",
            type: "video",
            url: "projects-videos/2_quiz0.mp4"
        },
    ]
    },
    links: {
...
},
{
    ...
    description: "Created a patient management platform using Node.js and Next.js.",
    detail: "",
...
},
{
    ...
    description: "Designed a political platform as a social network using Next.js and Node.js.",
    detail: "",
...
},
{
    ...
    description: "Built an evangelization platform using HTML, CSS, JS, and PHP.",
    detail: "",
...
},
{
    ...
    description: "Built a startup web platform using HTML, CSS, JS, and Webador.",
    detail: "",
    ...
    description: "Implemented an AI-powered chatbot integration for customer support using Node.js, React, and Dialogflow.",
    detail: "The AI Chatbot Integration project aimed to revolutionize customer support services by leveraging advanced artificial intelligence techniques. The solution was architected to streamline and automate customer interactions, reducing response times and improving overall satisfaction.\n\n\
    **Project Objectives:**\n\
    ...
    **Future Enhancements:**\n\
    ...
    category: "Personal",
    media: {
        cover: "https://artificialintelligence.oodles.io/wp-content/uploads/2019/08/Untitled-2-01.jpg",
        files: [{
            name: "Demo Video",
            type: "video",
